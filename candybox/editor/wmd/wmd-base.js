...
_fa.width="16px";
_fa.height="16px";
_fb.href="http://en.wikipedia.org/wiki/Markdown";
_fb.target="_blank";
_fb.title="如何书写？";
var _fc=_6.createImage("images/help.png");
var _fd=_6.createImage("images/help.png");
_fb.appendChild(_fc);
_fb.onmouseover=function(){
_6.setImage(_fc,"images/help.png");
